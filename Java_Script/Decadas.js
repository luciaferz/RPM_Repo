...
const DECADES = {
  1960: {
    ...
    intro:
      "Una seleccion de modelos que marcaron el inicio del automovil moderno.",
  ...
  1970: {
    ...
    intro:
      "Los 70 mezclaron potencia, diseno llamativo y superdeportivos inolvidables.",
    ...
    cars: [
      {
        ...
        features:
          "Diseno agresivo, motores V8, carroceria ancha y una imagen muy potente desde cualquier angulo.",
        images: [
      ...
      },
      {
        ...
        features:
          "Motor trasero, poco peso, aerodinamica mejorada y un comportamiento muy preciso en curva.",
        images: [
  ...
  1980: {
    ...
    intro:
      "En los 80 destacaron los coches llamativos y la influencia de la cultura pop.",
    ...
    cars: [
      ...
      },
      {
        ...
        features:
          "Traccion trasera, tamano compacto, buen reparto de pesos y enfoque claramente deportivo.",
        images: [
  ...
  1990: {
    ...
    intro:
      "La decada en la que muchos deportivos japoneses se volvieron legendarios.",
    ...
    cars: [
      {
        ...
        features:
          "Peso contenido, lineas suaves, motor rotativo biturbo y una respuesta muy directa al volante.",
        images: [
      ...
      },
      {
        ...
        features:
          "Motor 2JZ, traccion trasera, gran potencial de preparacion y una base mecanica muy resistente.",
        images: [
    ...
    cars: [
      {
        ...
        features:
          "Motor de seis cilindros, buen chasis, cambio deportivo y un aspecto elegante pero agresivo.",
        images: [
  ...
  2010: {
    ...
    intro:
      "La ultima etapa de la web muestra coches mas rapidos, tecnologicos y extremos.",
...
>>>>>>> 30cc6a771863f3e9108fb187a47771e2e07bd9c4
